...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 z-50 drop-shadow-lg flex justify-around items-center w-auto h-20 bg-gradient-to-r from-purple-300 from-10% via-blue-400 via-30% to-green-300 text-slate-900'>
      <ToastContainer/>
      <div className='flex justify-center items-center'>
        <Ambulance className='w-20 h-16 cursor-pointer'/>
        <h2 className='font-bold cursor-pointer'>HealthConnect<br></br>Info</h2>
      </div>
      <ul className='flex justify-center items-center gap-10'>
        <Link to='/'  className='hover:border-b-2 border-slate-600 cursor-pointer text-md'>Home</Link>
        <Link to = '/aboutUs'  className='hover:border-b-2 border-slate-600 cursor-pointer'>About us</Link>
        <Link to = '/contactUs'  className='hover:border-b-2 border-slate-600 cursor-pointer'>Contact us</Link>
