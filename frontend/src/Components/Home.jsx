...
const Home = () => {
  ...
  return (
    ...
    <div className="flex justify-evenly items-center w-auto h-auto bg-gradient-to-r from-purple-300 from-10% via-blue-400 via-30% to-green-300">
      <div className="flex-col justify-center items-center mt-5">
        <h1 className="text-5xl text-brown-600 font-bold mt-5 leading-tight">
